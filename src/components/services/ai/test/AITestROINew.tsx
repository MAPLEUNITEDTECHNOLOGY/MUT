...
export default function AITestROINew() {
  ...
  return (
    <section className="py-32 bg-[#020617] relative overflow-hidden">
      {/* Background Grid */}
      <div className="absolute inset-0 z-0 opacity-20 bg-[linear-gradient(rgba(0,229,255,0.05)_1px,transparent_1px),linear-gradient(90deg,rgba(0,229,255,0.05)_1px,transparent_1px)] bg-[size:20px_20px]" />

      <div className="container mx-auto px-6 md:px-12 lg:px-24 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          
          <div className="flex flex-col items-start">
            <span className="text-cyan-400 text-[11px] font-black uppercase tracking-[0.4em] mb-6">
              Economic Impact
            </span>
            ...
            <p className="text-slate-400 text-lg font-medium leading-relaxed max-w-xl">
              Our neural architectures don't just solve problems—they reshape 
              your economic bottom line with predictable, scalable yield metrics.
            </p>
          </div>

          <div className="glass-card-dark p-8 md:p-12 rounded-[2rem] border-cyan-400/20 glow-cyan">
            <div className="flex items-center justify-between mb-12">
              <div className="flex items-center gap-3">
                <div className="w-2 h-2 rounded-full bg-cyan-400 animate-pulse" />
                <span className="text-[10px] font-black tracking-widest text-cyan-400 uppercase">Live Simulation</span>
              </div>
            ...
            <div className="space-y-12">
              ...
              <div className="space-y-6">
                <div className="flex justify-between items-end">
                  ...
                  <span className="text-cyan-400 text-2xl font-black">{scale}%</span>
                </div>
                <input 
                  type="range" 
                  min="0" 
              ...
              <button className="w-full py-5 bg-transparent border border-cyan-400/30 text-cyan-400 rounded-sm font-black uppercase tracking-widest text-[11px] hover:bg-cyan-400/10 transition-colors">

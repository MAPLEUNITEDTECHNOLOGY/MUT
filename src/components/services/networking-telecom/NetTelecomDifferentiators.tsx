...
interface NetTelecomDifferentiatorsProps { sectionLabel: string; headline: string; subline: string; items: DiffItem[]; }

export default function NetTelecomDifferentiators({ sectionLabel, headline, subline, items }: NetTelecomDifferentiatorsProps) {
  return (

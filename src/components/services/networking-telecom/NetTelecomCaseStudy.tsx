...
interface NetTelecomCaseStudyProps {
...
export default function NetTelecomCaseStudy({ label, headline, industry, challenge, solution, outcome, imageSrc, testimonial }: NetTelecomCaseStudyProps) {
  return (

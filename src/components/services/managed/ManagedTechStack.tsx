...
export default function ManagedTechStack({ techStack }: { techStack: Tech[] }) {
  return (
    <section className="relative w-full bg-[#faf8ff] overflow-hidden">
      <div className="container mx-auto px-6 md:px-12 lg:px-24 py-24 md:py-32">
        <div className="max-w-3xl mb-16">
          ...
          <motion.h2 initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="text-4xl md:text-5xl lg:text-6xl font-black text-[#0f1a37] tracking-tight leading-[1.05] mb-6">Platforms & Tools We Operate Daily</motion.h2>
        </div>

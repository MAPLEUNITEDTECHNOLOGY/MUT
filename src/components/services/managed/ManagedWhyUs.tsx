...
interface ManagedWhyUsProps { sectionLabel: string; headline: string; differentiators: WhyUsItem[]; }

export default function ManagedWhyUs({ sectionLabel, headline, differentiators }: ManagedWhyUsProps) {
  return (

...
interface ManagedOverviewProps {
  sectionLabel: string;
  headline: string;
  subline: string;
  rows: OverviewRow[];
...
export default function ManagedOverview({ sectionLabel, headline, subline, rows, painPoints }: ManagedOverviewProps) {
  return (
    <section className="relative w-full bg-[#faf8ff]">
      {/* Part A: Overview alternating rows */}
      ...
      <div className="bg-[#0f1a37] py-24 md:py-32">
        <div className="container mx-auto px-6 md:px-12 lg:px-24">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="text-center mb-16">
            ...
            <h3 className="text-3xl md:text-4xl font-black text-white tracking-tight mt-4">What Holds Most IT Teams Back</h3>
          </motion.div>
